...
{
    public class UShortArithmeticLiteralTest
    {
        ...
        {
            // Arrange & Act
            var literal = new UShortArithmeticLiteral(42);
        ...
        {
            // Arrange & Act
            var literal = new UShortArithmeticLiteral(0);

            // Assert
            Assert.Equal((ushort)0, literal.Value);
        }
        ...
        {
            // Arrange & Act
            var literal = new UShortArithmeticLiteral(ushort.MaxValue);

            // Assert
            Assert.Equal(ushort.MaxValue, literal.Value);
        }
        #endregion
        ...
        {
            // Arrange
            var literal1 = new UShortArithmeticLiteral(10);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(10);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(15);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(100);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(50);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(5);
        ...
        public void Divide_WithArithmeticLiteral_CallsOtherLiteralDivideMethod()
        {
            ...
            // Assert
            Assert.Equal(0, result); // 10 / 50 = 0 for integer division
        }
        ...
        {
            // Arrange
            var literal1 = new UShortArithmeticLiteral(3);
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(3);
        ...
        {
            // Arrange
            var literal1 = new UShortArithmeticLiteral(12); // 1100 in binary
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(12); // 1100 in binary
        ...
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(12);
        ...
        public void Add_WithCharArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(charLiteral);
        ...
        public void Add_WithIntArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(intLiteral);
        ...
        public void Add_WithLongArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(longLiteral);
        ...
        public void Add_WithUIntArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(uintLiteral);
        ...
        public void Add_WithULongArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(ulongLiteral);
        ...
        public void Add_WithFloatArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(floatLiteral);
        ...
        public void Add_WithDoubleArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(doubleLiteral);
        ...
        public void Add_WithDecimalArithmeticLiteral_ReturnsCorrectResult()
        {
            ...
            // Act
            var result = ushortLiteral.Add(decimalLiteral);
        ...
        {
            // Arrange
            var ushortLiteral = new UShortArithmeticLiteral(42);
            var stringLiteral = new StringArithmeticLiteral("Answer: ");

            // Act
            var result = ushortLiteral.Add(stringLiteral);
        ...
        {
            // Arrange
            var literal1 = new UShortArithmeticLiteral(4);
            ...
            // Assert
            Assert.Equal(2, result); // 4 / 2 = 2
        }

        [Fact]
        public void Divide_WithPrimitiveValue_FollowsNormalOrder()
        {
            // Arrange
            var literal = new UShortArithmeticLiteral(4);

            // Act
            var result = literal.Divide((ushort)2);

            // Assert
            Assert.Equal(0, result); // 2 / 4 = 0
        }
        ...
        public void Subtract_WithArithmeticLiteral_DemonstratesOperationOrder()
        {
            // Arrange
            var literal1 = new UShortArithmeticLiteral(10);
            var literal2 = new UShortArithmeticLiteral(3);

            // Act - When passing ArithmeticLiteral, operation order is reversed
            var result = literal1.Subtract(literal2);

            // Assert
            Assert.Equal(7, result); // Reversed: 10 - 3 = 7
        }
        ...
        public void Subtract_WithPrimitiveValue_FollowsReversedOrder()
        {
            ...
            var result = literal.Subtract((ushort)10);

            // Assert
            Assert.Equal(7, result); // 10 - 3 = 7 (reversed order)
        }
        #endregion
    }
}